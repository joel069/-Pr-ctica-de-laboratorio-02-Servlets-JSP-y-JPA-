...
<link
	href="/Agenda_TelefonicaJPA/css/estilos.css"
	...
	<header>
		...
		<nav
			...
			<ul 
				...
				<li ><a
					href="/Agenda_TelefonicaJPA/index.html"
			...
			<form class=" col-xs-8 col-sm-4 col-md-4 col-mg-4 mr-sm-4"
				id="formulario"
				action="/Agenda_TelefonicaJPA/Search">
										...
										<div class="modal-dialog">
											<div 
												...
												<div >
													...
													<a
														href="/Agenda_TelefonicaJPA/EditPhone?delete=true&idTel=${telefono.codigo}"
						...
						<div class="modal fade" id="editar${i}" tabindex="-1"
							...
							<div class="modal-dialog modal-dialog-centered" role="document">
								<div class="modal-content"
									...
									<form
										action="/Agenda_TelefonicaJPA/EditPhone"
										method="POST">
	...
	<div class="modal fade" id="AddPhone" tabindex="-1" role="dialog"
		...
		<div class="modal-dialog modal-dialog-centered" role="document">
			<div class="modal-content"
				...
				<form
					action="/Agenda_TelefonicaJPA/AgregarPhone"
					method="POST">
